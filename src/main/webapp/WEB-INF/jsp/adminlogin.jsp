...
<nav class="navbar navbar-expand-lg" style="background-color:black;" id="navbar">
    ...
    <div class="row">
      <div class="col-md-5" id="side1">
        <h3 class="text-center" style="color:white">Fakt Owner sathi!</h3>
      </div>
      <div class="col-md-7" id="side2">
        <h3 class="text-center" style="color:black">Admin login</h3>
        <div class="container-fluid">
          <div class="row">
            <form class="row g-3 needs-validation" novalidate action="admin_login_controller.jsp" method="post">
              <div class="row" style="justify-content: center;">
                <div class="col-md-7 text-center input2">
                 
                  <div class="input-group has-validation">
                    <!-- <span class="input-group-text" id="inputGroupPrepend">@</span> -->
                    <input type="text" name="name" placeholder="Username" class="form-control" id="validationCustomUsername"
              ...
              <div class="row" style="justify-content: center;">
                <div class="col-md-7 text-center input2" >
                  ...
                  <div class="input-group has-validation">
                    <input type="password" name="pass" placeholder="Password" class="form-control" id="validationCustomUsername"
                      aria-describedby="inputGroupPrepend" maxlength="12" required>
                    <div class="invalid-feedback">
